...
class aura_maker_cage_channel : public AuraScript
{
    ...
    void Register() override
    {
        ...
        AfterEffectRemove += AuraEffectRemoveFn(aura_maker_cage_channel::AfterRemove, EFFECT_1, SPELL_AURA_ANY, AURA_EFFECT_HANDLE_REAL);
        AfterEffectRemove += AuraEffectRemoveFn(aura_maker_cage_channel::AfterRemove, EFFECT_2, SPELL_AURA_ANY, AURA_EFFECT_HANDLE_REAL);
    }
};
