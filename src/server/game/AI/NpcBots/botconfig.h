...
public:
    ...
    static bool IsNpcBotSpawnCommandEnabled();
    ...
    static uint32 GetAVRoleWeightTowerAssault();
    static uint32 GetAVRoleWeightCaptainAssault();
    static uint32 GetAVRoleWeightTowerDefense();
    static uint32 GetAVRoleWeightFrontline();
    static uint32 GetAVRoleWeightBaseDefense();
    static uint32 GetAVRoleWeightScout();
    static uint32 GetAVRoleDurationMinSeconds();
    static uint32 GetAVRoleDurationMaxSeconds();
    static uint32 GetAVBossRallyMaxBots();
    static uint32 GetAVBossDefenseMaxBots();
    static uint32 GetAVObjectiveDefenseMaxBots();
    static float GetAVAssaultSupportDistanceTower();
    static float GetAVAssaultSupportDistanceNode();
    static float GetAVDefenseSupportDistanceNode();
    static float GetAVCoveredNodeDistance();
    static float GetAVAggroDistanceMelee();
    static float GetAVAggroDistanceRanged();
    static float GetAVChaseDistanceMelee();
    static float GetAVChaseDistanceRanged();
