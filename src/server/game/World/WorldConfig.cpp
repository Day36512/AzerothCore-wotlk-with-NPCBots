...
void WorldConfig::BuildConfigCache()
{
    ...
    SetConfigValue<bool>(CONFIG_INCLUDE_FAKE_PLAYERS, "IncludeFakePlayers", true);
    ...
    SetConfigValue<uint32>(CONFIG_MAX_TALENT_POINTS, "MaxTalentPoints", 0, ConfigValueCache::Reloadable::Yes);
    ...
    SetConfigValue<bool>(CONFIG_ARENA_DISABLE_RING_OF_VALOR, "Arena.DisableRingOfValor", true);
    ...
    SetConfigValue<bool>(CONFIG_SMART_AI_CASTER_CHASE_REQUIRE_MAIN_SPELL, "SmartAI.CasterChase.RequireMainSpell", true);
