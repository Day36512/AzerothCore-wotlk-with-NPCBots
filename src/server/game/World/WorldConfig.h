...
enum ServerConfigs
{
    ...
    CONFIG_CREATURE_CHASE_STRICT_PATHING,
    CONFIG_SMART_AI_CASTER_CHASE_REQUIRE_MAIN_SPELL,
    ...
    CONFIG_ARENA_FORCE_NAGRAND_ARENA,
    CONFIG_ARENA_DISABLE_RING_OF_VALOR,
    CONFIG_ARENA_TEAM_INSTANT_CREATE,
    CONFIG_ARENA_TEAM_MIN_CREATE_LEVEL,
