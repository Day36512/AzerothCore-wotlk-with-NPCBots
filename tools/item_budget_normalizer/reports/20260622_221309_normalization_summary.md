...
- SQL origin filter: custom_only `False`, labels `['vanilla', 'tbc', 'wrath', 'custom_or_unknown']`, expansions `none`
- Target mode: `peer`
...
- Before/after CSV: `tools\item_budget_normalizer\reports\20260622_221309_normalization_report.csv`
- Calibration CSV: `tools\item_budget_normalizer\reports\20260622_221309_calibration.csv`
...
| 28148 | Bronze Mail Bracers | tbc | none | 10 | Uncommon | wrist | physical | no_peer_skip | 0 | 0.0 | not enough comparable peer samples | normal stats unchanged: not enough comparable peer samples; armor unchanged: not enough comparable armor samples |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1917 | Jeweled Dagger | vanilla | none | 10 | Uncommon | Dagger | 5.312 | 7.188 | report-only | normal stats unchanged: within +/-15% peer tolerance; weapon DPS median from 18 sample(s) within 5 ilvl; SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
...
| 18957 | Brushwood Blade | vanilla | none | 10 | Uncommon | Sword | 5.333 | 7.333 | report-only | normal stats unchanged: within +/-15% peer tolerance; weapon DPS median from 12 sample(s) within 5 ilvl; SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
...
| 816 | Small Hand Blade | vanilla | none | 11 | Uncommon | Dagger | 6.0 | 7.333 | report-only | normal stats unchanged: within +/-15% peer tolerance; weapon DPS median from 18 sample(s) within 5 ilvl; SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
...
| 3223 | Frostmane Scepter | vanilla | none | 11 | Uncommon | Mace | 5.909 | 7.727 | report-only | normal stats unchanged: within +/-15% peer tolerance; weapon DPS median from 17 sample(s) within 5 ilvl; SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
...
| 4947 | Jagged Dagger | vanilla | none | 11 | Uncommon | Dagger | 6.0 | 7.333 | report-only | normal stats unchanged: within +/-15% peer tolerance; weapon DPS median from 18 sample(s) within 5 ilvl; SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
| 4948 | Stinging Mace | vanilla | none | 11 | Uncommon | Mace | 5.87 | 7.609 | report-only | normal stats unchanged: within +/-15% peer tolerance; weapon DPS median from 17 sample(s) within 5 ilvl; SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
...
| 4303 | Cranial Thumper | vanilla | none | 12 | Uncommon | Mace | 6.429 | 7.5 | report-only | normal stats unchanged: within +/-15% peer tolerance; weapon DPS median from 21 sample(s) within 5 ilvl; SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
| 4974 | Compact Fighting Knife | vanilla | none | 12 | Uncommon | Dagger | 6.333 | 7.333 | report-only | normal stats unchanged: within +/-15% peer tolerance; weapon DPS median from 19 sample(s) within 5 ilvl; SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
...
| 3586 | Logsplitter | vanilla | none | 16 | Uncommon | Two-hand Axe | 10.833 | 12.639 | report-only | rounding remained outside configured tolerance; final visible stat budget adjusted to stay within +/-20% safety cap; weapon DPS median from 12 sample(s) within 5 ilvl; SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
| 1405 | Foamspittle Staff | vanilla | none | 17 | Uncommon | Staff | 11.406 | 11.406 | report-only | weapon DPS unchanged: within +/-15% peer tolerance from 16 sample(s); SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
| 3154 | Thelsamar Axe | vanilla | none | 18 | Uncommon | Axe | 9.048 | 7.619 | report-only | normal stats unchanged: within +/-15% peer tolerance; weapon DPS median from 13 sample(s) within 5 ilvl; SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
| 6094 | Piercing Axe | vanilla | none | 18 | Uncommon | Two-hand Axe | 11.818 | 11.818 | report-only | weapon DPS unchanged: within +/-15% peer tolerance from 14 sample(s); SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
| 6186 | Trogg Slicer | vanilla | none | 18 | Uncommon | Two-hand Sword | 11.912 | 11.912 | report-only | weapon DPS unchanged: within +/-15% peer tolerance from 12 sample(s); SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
| 15424 | Axe of Orgrimmar | vanilla | none | 18 | Uncommon | Two-hand Axe | 11.818 | 11.818 | report-only | rounding remained outside configured tolerance; final visible stat budget adjusted to stay within +/-20% safety cap; weapon DPS unchanged: within +/-15% peer tolerance from 14 sample(s); SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
...
| 6731 | Ironforge Breastplate | vanilla | none | 20 | Uncommon | Mail | 198 | 162 | report-only | final visible stat budget adjusted to stay within +/-20% safety cap; armor median from 20 sample(s) within 5 ilvl; SQL refused: changed item count exceeds safety.max_sql_updates; pass --allow-large-run |
